<x-sidebar-layout>
    ...
    <div class="max-w-2xl mx-auto mt-8">
        <div class="bg-white rounded-3xl shadow-xl shadow-indigo-100/50 border border-gray-100 overflow-hidden">
            ...
            <div class="bg-amber-800 p-8 text-white relative overflow-hidden">
                <div class="relative z-10">
                    <h2 class="text-2xl font-black italic tracking-tight">Halo, Warga 🙋‍♂️</h2>
                    <p class="text-indigo-100 text-sm mt-1">Satu langkah lagi sebelum kamu bisa mulai bayar iuran dan lapor kas di Sistem KAS RT 005.</p>
                </div>
            ...
            <form action="{{ route('profile.store') }}" method="POST" class="p-8 space-y-6">
                ...
                <div class="space-y-1">
                    <label class="text-[10px] font-black text-indigo-600 uppercase tracking-widest px-1">Status</label>
                ...
                <div class="pt-4">
                    <button type="submit" class="w-full bg-amber-800 text-white p-5 rounded-2xl font-black shadow-lg shadow-indigo-100 hover:bg-amber-950 hover:scale-[1.01] active:scale-95 transition-all uppercase tracking-widest">
                        Simpan
                    </button>
                    <p class="text-center text-[10px] text-gray-400 mt-4 font-bold uppercase tracking-tighter">
                        Pastikan data benar. Data ini akan digunakan untuk laporan kas RT 005.
                    </p>
                </div>
            </form>
        </div>
