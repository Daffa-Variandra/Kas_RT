            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm font-bold text-teal-900">{{ $p->contribution->nama_iuran }}</div>
                            <div class="text-sm font-black text-teal-600 font-mono">Rp {{ number_format($p->jumlah_bayar, 0, ',', '.') }}</div>
                        </td>
                        <td class="px-6 py-4 text-center">
                            <button @click="proofModal = true; activeImg = '{{ Storage::url($p->bukti_bayar) }}'" 
                                    class="p-2 bg-teal-50 text-teal-600 rounded-xl hover:bg-teal-100 transition-all shadow-sm border border-teal-100">
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            @else
                                <span class="px-3 py-1 text-[9px] font-black bg-emerald-100 text-emerald-700 rounded-full uppercase italic animate-pulse">Pending</span>
                            @endif
                        </td>
